...
namespace HOME.UI {
    ...
    public class LevelLoader : MonoBehaviour {
        ...
        [SerializeField] private LoadingBar _loadProgressBarPrefab;
        ...
        private void LoadLevelAsync(int levelIndex) { // start the coroutine to load asynchronously and generate a progress bar prefab
