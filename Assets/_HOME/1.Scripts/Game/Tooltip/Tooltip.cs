...
namespace HOME {
    public class Tooltip : MonoBehaviour {
      ...
      */
        ...
        public static void AddTooltip(Transform targTransform, Func<string> getTooltipStringFunc) {
            if (targTransform.GetComponentInChildren<UIEvents>(true) != null) {
                targTransform.GetComponentInChildren<UIEvents>(true).MouseOverOnceTooltipFunc = () => Tooltip.ShowTooltip_Static(getTooltipStringFunc);
                targTransform.GetComponentInChildren<UIEvents>(true).MouseOutOnceTooltipFunc = () => Tooltip.HideTooltip_Static();
            }
        }
    }
